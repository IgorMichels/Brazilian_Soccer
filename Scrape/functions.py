...
def treat_goal(goal, home, away):
    ...
    if 'Flamengo / RJ' in [home, away] and 'Flamengo' in goal:
        return time, 'Flamengo / RJ'
    
    if 'Vasco da Gama / RJ' in [home, away] and 'Vasco da Gama' in goal:
        return time, 'Vasco da Gama / RJ'
    
    if 'Fluminense / RJ' in [home, away] and 'Fluminense' in goal:
        return time, 'Fluminense / RJ'
    
    if 'Botafogo / RJ' in [home, away] and 'Botafogo' in goal:
        return time, 'Botafogo / RJ'
    
    if 'Madureira / RJ' in [home, away] and 'Madureira' in goal:
        return time, 'Madureira / RJ'
    
    if 'Resende / RJ' in [home, away] and 'Resende' in goal:
        return time, 'Resende / RJ'
    ...
    if 'Palmeiras / SP' in [home, away] and 'Palmeiras' in goal:
        return time, 'Palmeiras / SP'
    
    if 'São Paulo / SP' in [home, away] and 'São Paulo' in goal:
        return time, 'São Paulo / SP'
    
    if 'Corinthians / SP' in [home, away] and 'Corinthians' in goal:
        return time, 'Corinthians / SP'
    
    if 'Santos / SP' in [home, away] and 'Santos' in goal:
        return time, 'Santos / SP'
    
    if 'Red Bull Bragantino / SP' in [home, away] and 'Bragantino' in goal:
        return time, 'Red Bull Bragantino / SP'
    
    if 'Sao Bernardo / SP' in [home, away] and 'Sao Bernardo' in goal:
        return time, 'Sao Bernardo / SP'
    
    if 'São Bento / SP' in [home, away] and 'São Bento' in goal:
        return time, 'São Bento / SP'
    
    if 'Ponte Preta / SP' in [home, away] and 'Ponte Preta' in goal:
        return time, 'Ponte Preta / SP'
    
    if 'Portuguesa / SP' in [home, away] and 'Portuguesa' in goal:
        return time, 'Portuguesa / SP'
    
    if 'Santo André / SP' in [home, away] and 'Santo André' in goal:
        return time, 'Santo André / SP'
    
    if 'São Caetano / SP' in [home, away] and 'São Caetano' in goal:
        return time, 'São Caetano / SP'
    
    if 'Penapolense / SP' in [home, away] and 'Penapolense' in goal:
        return time, 'Penapolense / SP'
    
    if 'Botafogo / SP' in [home, away] and 'Botafogo' in goal:
        return time, 'Botafogo / SP'

    if 'Grêmio Barueri / SP' in [home, away] and 'Grêmio Barueri' in goal:
        return time, 'Grêmio Barueri / SP'

    if 'Mogi Mirim / SP' in [home, away] and 'Mogi Mirim' in goal:
        return time, 'Mogi Mirim / SP'

    if 'Guarani / SP' in [home, away] and 'Guarani' in goal:
        return time, 'Guarani / SP'

    if 'Oeste / SP' in [home, away] and 'Oeste' in goal:
        return time, 'Oeste / SP'

    if 'Guaratinguetá / SP' in [home, away] and 'Guaratinguetá' in goal:
        return time, 'Guaratinguetá / SP'
    
    if 'Atlético / MG' in [home, away] and 'Atlético' in goal:
        return time, 'Atlético / MG'
    
    if 'América / MG' in [home, away] and 'América' in goal:
        return time, 'América / MG'
    
    if 'Cruzeiro / MG' in [home, away] and 'Cruzeiro' in goal:
        return time, 'Cruzeiro / MG'
    
    if 'Villa Nova / MG' in [home, away] and 'Villa Nova' in goal:
        return time, 'Villa Nova / MG'
    
    if 'Tupi / MG' in [home, away] and 'Tupi' in goal:
        return time, 'Tupi / MG'
    
    if 'Araxá / MG' in [home, away] and 'Araxá' in goal:
        return time, 'Araxá / MG'

    if 'Betim / MG' in [home, away] and 'Betim' in goal:
        return time, 'Betim / MG'

    if 'Boa / MG' in [home, away] and 'Boa' in goal:
        return time, 'Boa / MG'
    
    if 'Aracruz / ES' in [home, away] and 'Aracruz' in goal:
        return time, 'Aracruz / ES'
        
    if 'Internacional / RS' in [home, away] and 'Internacional' in goal:
        return time, 'Internacional / RS'
    
    if 'Grêmio / RS' in [home, away] and 'Grêmio' in goal:
        return time, 'Grêmio / RS'
    
    if 'Juventude / RS' in [home, away] and 'Juventude' in goal:
        return time, 'Juventude / RS'
    
    if 'Lajeadense / RS' in [home, away] and 'Lajeadense' in goal:
        return time, 'Lajeadense / RS'

    if 'Caxias / RS' in [home, away] and 'Caxias' in goal:
        return time, 'Caxias / RS'
    
    if 'Athletico Paranaense / PR' in [home, away] and 'Atlético' in goal:
        return time, 'Athletico Paranaense / PR'
    
    if 'Coritiba / PR' in [home, away] and 'Coritiba' in goal:
        return time, 'Coritiba / PR'
    
    if 'Paraná / PR' in [home, away] and 'Paraná' in goal:
        return time, 'Paraná / PR'
    
    if 'Arapongas / PR' in [home, away] and 'Arapongas' in goal:
        return time, 'Arapongas / PR'
    
    if 'Londrina / PR' in [home, away] and 'Londrina' in goal:
        return time, 'Londrina / PR'
    
    if 'J. Malucelli / PR' in [home, away] and 'J. Malucelli' in goal:
        return time, 'J. Malucelli / PR'
    
    if 'Chapecoense / SC' in [home, away] and 'Chapecoense' in goal:
        return time, 'Chapecoense / SC'
    
    if 'Figueirense / SC' in [home, away] and 'Figueirense' in goal:
        return time, 'Figueirense / SC'
    
    if 'Criciúma / SC' in [home, away] and 'Criciuma' in goal:
        return time, 'Criciúma / SC'
    
    if 'Avaí / SC' in [home, away] and 'AVAÍ' in goal:
        return time, 'Avaí / SC'
    
    if 'Metropolitano / SC' in [home, away] and 'Metropolitano' in goal:
        return time, 'Metropolitano / SC'
    
    if 'Marcílio Dias / SC' in [home, away] and 'Marcílio Dias' in goal:
        return time, 'Marcílio Dias / SC'

    if 'Avaí / SC' in [home, away] and 'Avaí' in goal:
        return time, 'Avaí / SC'

    if 'Joinville / SC' in [home, away] and 'Joinville' in goal:
        return time, 'Joinville / SC'
        
    if 'Fortaleza / CE' in [home, away] and 'Fortaleza' in goal:
        return time, 'Fortaleza / CE'
    
    if 'Ceará / CE' in [home, away] and 'Ceará' in goal:
        return time, 'Ceará / CE'
    
    if 'Icasa / CE' in [home, away] and 'Icasa' in goal:
        return time, 'Icasa / CE'
    
    if 'Tiradentes / CE' in [home, away] and 'Tiradentes' in goal:
        return time, 'Tiradentes / CE'

    if 'Guarany / CE' in [home, away] and 'Guarany' in goal:
        return time, 'Guarany / CE'
    
    if 'Vitória da Conquista / BA' in [home, away] and 'Vitória da Conquista' in goal:
        return time, 'Vitória da Conquista / BA'
    
    if 'Vitória / BA' in [home, away] and 'Vitória' in goal:
        return time, 'Vitória / BA'
    
    if 'Bahia / BA' in [home, away] and 'Bahia' in goal:
        return time, 'Bahia / BA'

    if 'Juazeirense / BA' in [home, away] and 'Juazeirense' in goal:
        return time, 'Juazeirense / BA'
    
    if 'ABC / RN' in [home, away] and 'A.b.c.' in goal:
        return time, 'ABC / RN'
    
    if 'América / RN' in [home, away] and 'América' in goal:
        return time, 'América / RN'

    if 'Potiguar / RN' in [home, away] and 'Potiguar' in goal:
        return time, 'Potiguar / RN'

    if 'Baraúnas / RN' in [home, away] and 'Baraúnas' in goal:
        return time, 'Baraúnas / RN'
    
    if 'Salgueiro / PE' in [home, away] and 'Salgueiro' in goal:
        return time, 'Salgueiro / PE'
    
    if 'Sport / PE' in [home, away] and 'Sport' in goal:
        return time, 'Sport / PE'
    
    if 'Central / PE' in [home, away] and 'Central' in goal:
        return time, 'Central / PE'

    if 'Santa Cruz / PE' in [home, away] and 'Santa Cruz' in goal:
        return time, 'Santa Cruz / PE'

    if 'Ypiranga / PE' in [home, away] and 'Ypiranga' in goal:
        return time, 'Ypiranga / PE'

    if 'Náutico / PE' in [home, away] and 'Náutico' in goal:
        return time, 'Náutico / PE'
    
    if 'Confiança / SE' in [home, away] and 'Confiança' in goal:
        return time, 'Confiança / SE'
    
    if 'Sergipe / SE' in [home, away] and 'Sergipe' in goal:
        return time, 'Sergipe / SE'
    
    if 'ASA / AL' in [home, away] and 'A.s.a.' in goal:
        return time, 'ASA / AL'

    if 'CSA / AL' in [home, away] and 'C.s.a.' in goal:
        return time, 'CSA / AL'
        
    if 'CRB / AL' in [home, away] and 'C.r.b.' in goal:
        return time, 'CRB / AL'
        
    if 'Botafogo / PB' in [home, away] and 'Botafogo' in goal:
        return time, 'Botafogo / PB'
    
    if 'Treze / PB' in [home, away] and 'Treze' in goal:
        return time, 'Treze / PB'

    if 'Parnahyba / PI' in [home, away] and 'Parnahyba' in goal:
        return time, 'Parnahyba / PI'

    if 'Sampaio Corrêa / MA' in [home, away] and 'Sampaio Correa' in goal:
        return time, 'Sampaio Corrêa / MA'

    if 'Maranhão / MA' in [home, away] and 'Maranhão' in goal:
        return time, 'Maranhão / MA'

    if 'Cuiabá / MT' in [home, away] and 'Cuiabá' in goal:
        return time, 'Cuiabá / MT'
    
    if 'Luverdense / MT' in [home, away] and 'Luverdense' in goal:
        return time, 'Luverdense / MT'
    
    if 'Mixto / MT' in [home, away] and 'Mixto' in goal:
        return time, 'Mixto / MT'
    
    if 'Naviraiense / MS' in [home, away] and 'Naviraiense' in goal:
        return time, 'Naviraiense / MS'
        
    if 'Águia Negra / MS' in [home, away] and 'Aguia Negra' in goal:
        return time, 'Águia Negra / MS'
    
    if 'Goiás / GO' in [home, away] and 'Goiás' in goal:
        return time, 'Goiás / GO'
    
    if 'Aparecidense / GO' in [home, away] and 'Aparecidense' in goal:
        return time, 'Aparecidense / GO'
    
    if 'CRAC / GO' in [home, away] and 'C.r.a.c.' in goal:
        return time, 'CRAC / GO'
    
    if 'Goianesia / GO' in [home, away] and 'Goianesia' in goal:
        return time, 'Goianesia / GO'

    if 'Vila Nova / GO' in [home, away] and 'Vila Nova' in goal:
        return time, 'Vila Nova / GO'

    if 'Atlético / GO' in [home, away] and 'Atlético' in goal:
        return time, 'Atlético / GO'
    
    if 'Brasília / DF' in [home, away] and 'Brasília' in goal:
        return time, 'Brasília / DF'

    if 'Brasiliense / DF' in [home, away] and 'Brasiliense' in goal:
        return time, 'Brasiliense / DF'
        
    if 'Nacional / AM' in [home, away] and 'Nacional' in goal:
        return time, 'Nacional / AM'

    if 'Ypiranga / AP' in [home, away] and 'Ypiranga' in goal:
        return time, 'Ypiranga / AP'
    
    if 'Paysandu / PA' in [home, away] and 'Paysandu' in goal:
        return time, 'Paysandu / PA'
    
    if 'Águia de Marabá / PA' in [home, away] and 'Aguia' in goal:
        return time, 'Águia de Marabá / PA'

    if 'Paragominas / PA' in [home, away] and 'Paragominas' in goal:
        return time, 'Paragominas / PA'
    
    if 'Gurupi / TO' in [home, away] and 'Gurupi' in goal:
        return time, 'Gurupi / TO'
    
    if 'Plácido de Castro / AC' in [home, away] and 'Plácido de Castro' in goal:
        return time, 'Plácido de Castro / AC'

    if 'Rio Branco / AC' in [home, away] and 'Rio Branco' in goal:
        return time, 'Rio Branco / AC'

    if 'Genus / RO' in [home, away] and 'Genus' in goal:
